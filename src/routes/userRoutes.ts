...
const create = async (req: Request, res: Response) => {
    try {
        ...
        const user: User = await userModel.create(req.body.firstName, req.body.lastName, req.body.email, req.body.password);
...
const update = async (req: Request, res: Response) => {
    try {
        const user: User | null = await userModel.update(req.params.id as unknown as number, req.body.firstName, req.body.lastName, req.body.email, req.body.password);
        res.json(user);
    } catch (err) {
...
const remove = async (req: Request, res: Response) => {
    try {
        const user: User | null = await userModel.delete(req.params.id as unknown as number);
        res.json(user);
    } catch (err) {
...
router.post('/test', upload.any(), (req: Request, res: Response) => {  // upload.any() handles any type of file
